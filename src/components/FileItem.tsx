...
export function FileItem({
	...
	const FileIcon = () => {
		...
		const iconMap: Record<string, LucideIcon> = {
			...
			csv: <FileChartColumn size={18} fill="#00D402" stroke="#E5FFE6" strokeWidth={1.5} />,
			...
			icns: <FileImage size={18} fill="#FF7802" stroke="#FFDEC1" strokeWidth={1.5} />,
			ico: <FileImage size={18} fill="#FF7802" stroke="#FFDEC1" strokeWidth={1.5} />,
			...
			svg: <FileImage size={18} fill="#2A65CE" stroke="#C4D5F3" strokeWidth={1.5} />,
			webp: <FileImage size={18} fill="#2A65CE" stroke="#C4D5F3" strokeWidth={1.5} />,
			pxd: <FileImage size={18} fill="#D55C77" stroke="#FFB6A1" strokeWidth={1.5} />,
			psd: <FileImage size={18} fill="#D55C77" stroke="#FFB6A1" strokeWidth={1.5} />,
			...
			m4a: <FileAudio size={18} fill="#D55C77" stroke="#FFB6A1" strokeWidth={1.5} />,
			flac: <FileAudio size={18} fill="#D55C77" stroke="#FFB6A1" strokeWidth={1.5} />,
			wav: <FileAudio size={18} fill="#D55C77" stroke="#FFB6A1" strokeWidth={1.5} />,
			mp4: <FileVideo size={18} fill="#7D00E8" stroke="#B2ADFB" strokeWidth={1.5} />,
			mov: <FileVideo size={18} fill="#7D00E8" stroke="#B2ADFB" strokeWidth={1.5} />,
			zip: <FolderArchive size={18} fill="#F3F3F3" stroke="#000" strokeWidth={1.5} />,
			tar: <FolderArchive size={18} fill="#F3F3F3" stroke="#000" strokeWidth={1.5} />,
			gz: <FolderArchive size={18} fill="#F3F3F3" stroke="#000" strokeWidth={1.5} />,
			...
			db: <FileCode2 size={18} fill="#FFA500" stroke="#FFE2B0" strokeWidth={1.5} />,
			...
			lua: <FileCode2 size={18} fill="#739CFC" stroke="#C9D8FE" strokeWidth={1.5} />,
			...
			dmg: <FileDigit size={18} fill="#000" stroke="#F3F3F3" strokeWidth={1.5} />,
